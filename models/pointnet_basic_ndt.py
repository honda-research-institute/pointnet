...
class PNetBasicNDT(object):
    ...
    def _set_up_input_pls(self):
        self.pointclouds_pl = tf.placeholder(tf.float32, shape=(self.batch_size, self.num_point, 7))
    ...
    def build(self):
        ...
        net = tf_util.conv2d(input_image, 64, [1, 7],
    ...
    def get_input_pls(self):
        return self.pointclouds_pl, self.labels_pl, self.is_training_pl
